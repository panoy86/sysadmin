...
This also can only work if the outbound path of and email sent from production to the test/dev tenant follows the same path as all other externally-bound emails.
