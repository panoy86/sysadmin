...
Not a turnkey script, but I use these to export DL (and all relevant info) from a source Exchange tenant, to re-create the DLs onto a new target Exchange tenant.
