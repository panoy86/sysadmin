...
function udf_AuthGraphApi
{
    ...
    $sTenantId = ""
    $sClientId = ""  #-- files.readwrite.all, sites,readwrite.all
    $sSecretB64 = "" #-- (expires 2/23/2025)
...
function udf_GetDriveId
{
    ...
    #-- Get the site id
    $sUri = 'https://graph.microsoft.com/v1.0/sites/somedomain-my.sharepoint.com:/' + $sRelativeUrl
